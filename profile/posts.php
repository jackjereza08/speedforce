                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-timeline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <span><input type="button" name=<?php echo "comment".$row['postid'];?> onclick=<?php echo "comment(".$row['postid'].",".$_SESSION['speedster_id'].")";?> class="btn btn-danger" value="Comment"></span>
                            </div>
                        </div
                        <br>  
                        <div class="row">
